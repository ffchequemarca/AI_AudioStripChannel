function [Output_Signal,Frequency_Spectrum] = EQ_8Band(Input_Signal,Sample_Rate,HiPass_Parameters,LoShelf_Parameters,HiShelf_Parameters,LoPass_Parameters,Bell1_Parameters,Bell2_Parameters,Bell3_Parameters,Bell4_Parameters)
%Input_Signal,Sample
...
Out7 = Bell_Filter(Out6,Sample_Rate,Bell3_Parameters(1),Bell3_Parameters(2),Bell3_Parameters(3),Bell3_Parameters(4));
Out8 = Bell_Filter(Out7,Sample_Rate,Bell4_Parameters(1),Bell4_Parameters(2),Bell4_Parameters(3),Bell4_Parameters(4));
